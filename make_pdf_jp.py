...
def create_summary_pdfs(database_path, template_path, output_dir='output', language='japanese', split_files=True, papers_per_file=100):
    ...
    # データベースから情報を取得
    cursor.execute("SELECT english_title,japanese_title, authors, paper_link, key_visual_url, summary_japanese, problem_japanese, method_japanese, results_japanese FROM pdf_summaries")
