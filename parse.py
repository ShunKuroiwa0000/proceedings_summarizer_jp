    ...
    for i in range(pdf.page_count):
        ...
        if any(keyword in text.lower() for keyword in ["概要：","keyword","ABSTRACT"]) or i == pdf.page_count - 1:
            ...
            if page_start == None:
                ...
                with open("data/{}/first_page_text.txt".format(page_start),"w",encoding="utf-8") as f:
                ...
                with open("data/{}/title.txt".format(page_start),"w",encoding="utf-8") as f:
                    f.write(title)
                ...
                print("Debug: Creating data folder")  # ログ追加
                print(f"Debug: Saving paper.pdf from page {page_start} to {page_end}")  # ログ追加
